  ...
  const projects = [
    {
      ...
      description: 'A decentralized exchange built on Ethereum with automated market making and yield farming capabilities.',
    ...
    },
    {
      ...
      description: 'A full-featured NFT marketplace with minting, trading, and auction functionality on Polygon.',
    ...
    },
    {
      ...
      description: 'Decentralized social media platform with token-gated content and on-chain reputation system.',
    ...
    },
    {
      ...
      description: 'VSCode extension that provides intelligent code suggestions and documentation using machine learning.',
