  ...
  const experiences = [
    {
      ...
      company: 'DeFi Labs',
      period: '2022 - Present',
      description: 'Leading development of decentralized finance protocols and smart contract infrastructure.',
      achievements: [
    ...
    },
    {
      ...
      period: '2020 - 2022',
      description: 'Built scalable web applications and led migration to microservices architecture.',
      achievements: [
                ...
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50 hover:border-cyan-500/50 transition-colors">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-slate-200 mb-1">{exp.title}</h3>
